...
(function (exports) {
    ...
    function typeStr(obj) {
      return isArray(obj) ? 'array' : babelHelpers["typeof"](obj);
    }
    ...
    function hasProperty(obj, propName) {
      return obj != null && babelHelpers["typeof"](obj) === 'object' && propName in obj;
    }
    ...
    function primitiveHasOwnProperty(primitive, propName) {
      return primitive != null && babelHelpers["typeof"](primitive) !== 'object' && primitive.hasOwnProperty && primitive.hasOwnProperty(propName);
    }
    ...
    Writer.prototype.renderSection = function renderSection(token, context, partials, originalTemplate, config) {
      ...
      } else if (babelHelpers["typeof"](value) === 'object' || typeof value === 'string' || typeof value === 'number') {
    ...
    Writer.prototype.getConfigTags = function getConfigTags(config) {
      if (isArray(config)) {
        return config;
      } else if (config && babelHelpers["typeof"](config) === 'object') {
        return config.tags;
      } else {
        return undefined;
      }
    ...
    Writer.prototype.getConfigEscape = function getConfigEscape(config) {
      if (config && babelHelpers["typeof"](config) === 'object' && !isArray(config)) {
    ...
    var mustache$1 = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
      (babelHelpers["typeof"](exports)) === 'object' && 'object' !== 'undefined' ? module.exports = factory() : (global = global || self, global.Mustache = factory());
    ...
    var Base = /*#__PURE__*/function () {
      ...
      babelHelpers.createClass(Base, [{
        ...
        key: "getEntityById",
        value: function getEntityById(id, entities) {
          var entity = null;
        ...
        key: "renderMustache",
        value: function renderMustache(templateId, targetId, data) {
          var mixId = "".concat(templateId, "_").concat(targetId),
            templateHtml = null,
            $target = null;
          ...
          $target.innerHTML = mustache$1.render(templateHtml, data);
        }
      }]);
      return Base;
    }();
    ...
    var Data = /*#__PURE__*/function (_Base) {
      babelHelpers.inherits(Data, _Base);
      function Data(id) {
        var _this;
        var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var result = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        ...
        _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(Data).call(this, id, params, result, options));
        _this.activeNavigationId = 0;
        _this.init();
        return _this;
      }
      babelHelpers.createClass(Data, [{
        ...
        value: function addEventListeners() {
          var _this2 = this;
          this.$component.on('click', '.js-agrebnev-wikiinside-sec', function (event) {
            var id = Number.parseInt(event.target.dataset.id);
            _this2.showSectionById(id);
            _this2.render();
          });
          this.$component.on('click', '.js-agrebnev-wikiinside-elem', function (event) {
            var id = Number.parseInt(event.target.dataset.id);
            _this2.showElementById(id);
            _this2.render();
          });
        }
      }, {
        key: "showSectionById",
        value: function showSectionById(id) {
          var entity = this.getSectionById(id);
          if (!entity) {
            this.fillIblockData();
            this.fillAddUrl();
            return;
        ...
        value: function showElementById(id) {
          var entity = this.getElementById(id);
          if (!entity) {
            return;
          }
          this.result.JS_DATA.CURRENT_DATA.ID = entity.ID;
        ...
        key: "fillStartData",
        value: function fillStartData() {
          this.fillIblockData();
          var currentData = this.getCurrentDataByUrl();
          if (null !== currentData) {
        ...
        key: "fillAddUrl",
        value: function fillAddUrl() {
          var $link = this.$component.querySelector('.js-agrebnev-wikiinside-addnew');
          if (!$link.dataset.startAddNewLink) {
            $link.dataset.startAddNewLink = $link.getAttribute('href');
          }
          $link.setAttribute('href', "".concat($link.dataset.startAddNewLink, "&IBLOCK_SECTION_ID=").concat(this.activeNavigationId));
        }
      }, {
        key: "getCurrentDataByUrl",
        value: function getCurrentDataByUrl() {
          if (0 === this.result.JS_DATA.ITEMS.length || '' === this.params.LOCATION_PATHNAME) {
            return null;
          }
          var finedItem = null;
          var _iterator = _createForOfIteratorHelper$1(this.result.JS_DATA.ITEMS),
            _step;
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var item = _step.value;
              var approve = false;
              var approveParamsCount = 0;
              ...
              if (0 < Object.values(item.SEARCH).length) {
                ...
                for (var name in item.SEARCH) {
                  var param = "".concat(name, "=").concat(item.SEARCH[name]);
        ...
        value: function renderNavigation() {
          var blockId = "".concat(this.id, "-menu"),
            startItem = {
              ID: 0,
          ...
          var funcSetActive = function funcSetActive(items, activeId) {
          ...
          this.renderMustache("".concat(blockId, "-template"), "".concat(blockId, "-target"), data);
        }
      }, {
        key: "renderBody",
        value: function renderBody() {
          var _this3 = this;
          var blockId = "".concat(this.id, "-body"),
            data = Object.assign({}, {
              EDIT_URL: '',
              HAS_ELEMENTS: false,
              ELEMENTS: []
            }, this.result.JS_DATA.CURRENT_DATA);
          data.ELEMENTS = this.result.JS_DATA.ITEMS.filter(function (item) {
            return Number.parseInt(_this3.activeNavigationId) === Number.parseInt(item.IBLOCK_SECTION_ID);
          });
          data.HAS_ELEMENTS = 0 < data.ELEMENTS.length;
          data.ELEMENTS = data.ELEMENTS.map(function (item) {
            var rewriteFields = {
...
}((this.AgrebnevWikiInside.Components = this.AgrebnevWikiInside.Components || {})));
